...
function fetchWeeklyRoutine() {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      let faculty_monday_period_1 = document.getElementById(
        "faculty-monday-period-1"
      );
      faculty_monday_period_1.innerText = data.data[0].faculty[0].faculty_name;
      let roomno_monday_period_1 = document.getElementById(
      ...
      let faculty_tuesday_period_1 = document.getElementById(
        "faculty-tuesday-period-1"
      );
      faculty_tuesday_period_1.innerText = data.data[1].faculty[0].faculty_name;
      let roomno_tuesday_period_1 = document.getElementById(
      ...
      let faculty_wednesday_period_1 = document.getElementById(
        "faculty-wednesday-period-1"
      );
      faculty_wednesday_period_1.innerText =
        data.data[2].faculty[0].faculty_name;
      let roomno_wednesday_period_1 = document.getElementById(
      ...
      let faculty_thursday_period_1 = document.getElementById(
        "faculty-thursday-period-1"
      );
      faculty_thursday_period_1.innerText =
        data.data[3].faculty[0].faculty_name;
      let roomno_thursday_period_1 = document.getElementById(
      ...
      let faculty_friday_period_1 = document.getElementById(
        "faculty-friday-period-1"
      );
      faculty_friday_period_1.innerText = data.data[4].faculty[0].faculty_name;
      let roomno_friday_period_1 = document.getElementById(
      ...
      let faculty_monday_period_2 = document.getElementById(
        "faculty-monday-period-2"
      );
      faculty_monday_period_2.innerText = data.data[5].faculty[0].faculty_name;
      let roomno_monday_period_2 = document.getElementById(
      ...
      let faculty_tuesday_period_2 = document.getElementById(
        "faculty-tuesday-period-2"
      );
      faculty_tuesday_period_2.innerText = data.data[6].faculty[0].faculty_name;
      let roomno_tuesday_period_2 = document.getElementById(
      ...
      let faculty_wednesday_period_2 = document.getElementById(
        "faculty-wednesday-period-2"
      );
      faculty_wednesday_period_2.innerText =
        data.data[7].faculty[0].faculty_name;
      let roomno_wednesday_period_2 = document.getElementById(
      ...
      let faculty_thursday_period_2 = document.getElementById(
        "faculty-thursday-period-2"
      );
      faculty_thursday_period_2.innerText =
        data.data[8].faculty[0].faculty_name;
      let roomno_thursday_period_2 = document.getElementById(
      ...
      let faculty_friday_period_2 = document.getElementById(
        "faculty-friday-period-2"
      );
      faculty_friday_period_2.innerText = data.data[9].faculty[0].faculty_name;
      let roomno_friday_period_2 = document.getElementById(
      ...
      let faculty_monday_period_3 = document.getElementById(
        "faculty-monday-period-3"
      );
      faculty_monday_period_3.innerText = data.data[10].faculty[0].faculty_name;
      let roomno_monday_period_3 = document.getElementById(
      ...
      let faculty_tuesday_period_3 = document.getElementById(
        "faculty-tuesday-period-3"
      );
      faculty_tuesday_period_3.innerText =
        data.data[11].faculty[0].faculty_name;
      let roomno_tuesday_period_3 = document.getElementById(
      ...
      let faculty_wednesday_period_3 = document.getElementById(
        "faculty-wednesday-period-3"
      );
      faculty_wednesday_period_3.innerText =
        data.data[12].faculty[0].faculty_name;
      let roomno_wednesday_period_3 = document.getElementById(
      ...
      let faculty_thursday_period_3 = document.getElementById(
        "faculty-thursday-period-3"
      );
      faculty_thursday_period_3.innerText =
        data.data[13].faculty[0].faculty_name;
      let roomno_thursday_period_3 = document.getElementById(
      ...
      let faculty_friday_period_3 = document.getElementById(
        "faculty-friday-period-3"
      );
      faculty_friday_period_3.innerText = data.data[14].faculty[0].faculty_name;
      let roomno_friday_period_3 = document.getElementById(
